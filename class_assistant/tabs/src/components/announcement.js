    ...
    const items = this.state.items?.map((item, index) =>
      <div key={index} className="item">
        ...
        <div className='delete'>
              <Button primary onClick={() => this.onDelete(this.state.items[index].id,this.state.items[index].title) }>删除</Button>
        </div>
      </div>
    );
            ...
            <div className="todo">
              <div className="header">
                ...
                <div className="add-button">
                  <Button  primary onClick={() => this.setState({ isAddingItem: true })}>+ Add Announcement</Button>
                </div>
              </div>  
              {items}
